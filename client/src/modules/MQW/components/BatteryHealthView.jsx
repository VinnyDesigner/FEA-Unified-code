...
const BatteryHealthView = ({ isMobile = false, selectedBuoy = 'Al Aqah Buoy', selectedDuration = 'Last Day' }) => {
  ...
  return (
    <div className="flex flex-col gap-6 w-full h-full overflow-y-auto analytics-panel-scroll">
      ...
      {showNearshore && (
        <div className={`flex ${isMobile ? 'flex-col gap-4' : 'flex-row'} w-full animate-fadeIn`}>
      ...
      {showNorthDibbah && (
        <div className={`flex ${isMobile ? 'flex-col gap-4' : 'flex-row'} w-full pb-6 animate-fadeIn`}>
