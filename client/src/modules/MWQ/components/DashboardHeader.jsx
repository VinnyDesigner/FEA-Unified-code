        ...
        >
          <span className="truncate text-[#072227] text-[12px] font-semibold">
            {selectedBuoy?.nameKey
              ...
              : (selectedBuoy?.buoyName || selectedBuoy?.name || t('analytics.selectStation', 'Select Station'))}
          </span>
          <ChevronDown
            size={13}
              ...
              return (
                ...
                >
                  ...
                  <span className="text-white text-[13px] font-semibold group-hover:text-[#1DCDDD] transition-colors">
                    {station.nameKey ? t(`stations.${station.nameKey}`) : (station.buoyName || station.name)}
                  </span>
                </button>
              );
            })}
