...
CREATE TABLE "SchemaInit" (
    ...
    CONSTRAINT "SchemaInit_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "aqms_parameter_masters" ADD CONSTRAINT "aqms_parameter_masters_UnitID_fkey" FOREIGN KEY ("UnitID") REFERENCES "aqms_measurement_units"("UnitID") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "aqms_measurement_units" ADD CONSTRAINT "aqms_measurement_units_ParameterID_fkey" FOREIGN KEY ("ParameterID") REFERENCES "aqms_parameter_masters"("ParameterID") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "aqms_notification_logs" ADD CONSTRAINT "aqms_notification_logs_UserID_fkey" FOREIGN KEY ("UserID") REFERENCES "users"("UserID") ON DELETE RESTRICT ON UPDATE CASCADE;
